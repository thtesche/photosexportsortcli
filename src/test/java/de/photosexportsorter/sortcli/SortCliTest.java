...
class SortCliTest {
    ...
    void testReSortWithEnglishDate() {
        ...
        // Wait, the logic splits by comma. "New York, May 15, 2024" -> ["New York", " May 15", " 2024"]
    ...
    void testProblematicDateConversionWithUnicodeDecomposition() {
        ...
        assertTrue(result.targetDir().contains("2024-03-15"), "Should handle NFD decomposition. Got: " + result.targetDir());
    }
}
