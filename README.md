...
```bash
java -jar target/macfotocli-1.4-SNAPSHOT-jar-with-dependencies.jar doctor
```
...
**Example:**
```bash
java -jar target/macfotocli-1.4-SNAPSHOT-jar-with-dependencies.jar sort \
...
```bash
java -jar target/macfotocli-1.4-SNAPSHOT-jar-with-dependencies.jar tag \
  --model=gemma4 \
...
**Example (Dry Run):**
```bash
java -jar target/macfotocli-1.4-SNAPSHOT-jar-with-dependencies.jar fixdate \
  --dryRun \
  /path/to/200*
```
