...
```bash
java -jar target/macfotocli-1.6.1-jar-with-dependencies.jar doctor
```
...
```bash
java -jar target/macfotocli-1.6.1-jar-with-dependencies.jar sort \
...
```bash
java -jar target/macfotocli-1.6.1-jar-with-dependencies.jar tag \
  --model=gemma4 \
...
```bash
java -jar target/macfotocli-1.6.1-jar-with-dependencies.jar visiontag \
...
```bash
java -jar target/macfotocli-1.6.1-jar-with-dependencies.jar fixdate \
  --dryRun \
  /path/to/200*
```
